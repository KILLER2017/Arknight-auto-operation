...
var gamePicture = [
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/startGame.png"),
        "tip": "开始游戏" 
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/shortcut.png"),
        "tip": "快捷方式" 
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/lastFight.png"),
        "tip": "终端" 
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/small_start_action.jpg"), 
        "tip": "准备战斗"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/large_start_action.jpg"), 
        "tip": "开始行动"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/in_battle.jpg"),
        "tip": "战斗中"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/battle_completion.jpg"),
        "tip": "战斗结束"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/yaoji.jpg"),
        "tip": "理智不足"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/friend_list_1.png"),
        "tip": "首页"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/friend_list_2.png"),
        "tip": "个人名片"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/friend_list_3.png"),
        "tip": "好友列表"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/friend_list_4.png"),
        "tip": "重复领取信用"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/friend_list_5.png"),
        "tip": "不能拜访"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/friendList7.png"),
        "tip": "可以领取信赖"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/基建TIP.png"),
        "tip": "基建一键领取TIP"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/基建制造站TIP.png"),
        "tip": "基建制造站TIP"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/基建贸易站TIP.png"),
        "tip": "基建贸易站TIP"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/基建干员疲劳TIP.png"),
        "tip": "基建干员疲劳TIP"
    },
    {
        "image": images.read("/sdcard/脚本/明日方舟自律行动/img/基建处理完毕.png"),
        "tip": "基建处理完毕"
    }
]
